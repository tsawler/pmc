			...
			<div class="yui-b">
				<div class="yui-ge">
					<div class="yui-u first"><!-- content div -->
							...
							<%
							int comment_id = 0;
							comment_id = Integer.parseInt((String) request.getParameter("id"));
							...
							while (rs.next()){
								...
								message = rs.getString("story_comment");
							}
							...
							<form name="bookform" id="bookform" method="post" action="/doeditcomment.jsp">
							...
							<input type="button" value="Cancel" onclick="location.href='/comments/jpage/1/p/comments/content.do'" class="inputbox" />
							</form>
							<br />
							<br />
					</div>
