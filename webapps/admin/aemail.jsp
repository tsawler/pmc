...
GenericTable myTableObject = new GenericTable(" standard_email_messages ");
myTableObject.setConn(conn);
myTableObject.setSSelectWhat(" * ");
myTableObject.setSCustomOrder("");
...
<table style="padding: 0; border: 1px solid silver; height: 95%; width: 100%;">
  ...
  <tr>
    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
        ...
        <tr style="height: 15px;">
        <td class="tableheader"><!-- InstanceBeginEditable name="Title" -->Maintain Automatic Email Messages<!-- InstanceEndEditable --></td>
        </tr>
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/aemail/jpage/1/p/AutoEmail/admin/1/content.do" export="false" id="plinksobj" pagesize="<%=pagesize%>"  class="tabledatacollapse" style="width: 100%" >
			 <display:column property="message_name" title="Message" href="/admin/jpage/1/p/EditAutoEmail/a/editautoemail/admin/1/content.do?id=0&edit=false&cancelPage=/aemail/jpage/1/p/AutoEmail/admin/1/content.do?edit=false" paramId="id" paramProperty="message_id"  />
			</display:table>
		</div>
