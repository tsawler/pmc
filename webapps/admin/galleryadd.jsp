...
<%
		if (request.getParameter("gallery_id") != null) {
			...
			response.sendRedirect("/galleryitemdetail/jpage/1/p/gallery/admin/1/content.do?id=0");
			return;
		}
		%>
<!-- InstanceEndEditable -->
...
// -->
		...
		<form name="newsform" id="newsform" action="/galleryadd/jpage/1/p/gallery/admin/1/content.do" method="post">
