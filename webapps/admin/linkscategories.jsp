...
myTableObject.setSSelectWhat(" links_cat_id, title, case when active_yn = 'y' then '<span style=\"color: green\">active</span>' else '<span style=\"color: red\">inactive</span>' end as status ");
...
<table style="padding: 0; border: 1px solid silver; height: 95%; width: 100%;">
  ...
  <tr>
    ...
    <td class="tabledata" style="border: 1px solid silver;" valign="top" width="83%" cellpadding="0" cellspacing="0">
        ...
        <tr style="height: 15px;">
        <td class="tableheader"><!-- InstanceBeginEditable name="Title" -->Maintain Web Link Categories<!-- InstanceEndEditable --></td>
        </tr>
		...
		<div>
			<display:table name="requestScope.results.rows" requestURI="/linkscategories/jpage/1/p/LinkCategory/admin/1/content.do" export="false" id="linksobj" pagesize="<%=pagesize%>"  class="tabledatacollapse" style="width: 100%" >
			 <display:column property="title" title="Category" href="/admin/jpage/1/p/EditWebLinksCat/a/editweblinkscategories/class/linkcat/admin/1/content.do?edit=false&cancelPage=/linkscategories/jpage/1/p/LinkCategory/admin/1/content.do" paramId="id" paramProperty="links_cat_id"  />
