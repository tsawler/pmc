			...
			<div class="yui-b">
				<div class="yui-ge">
					<div class="yui-u first"><!-- content div -->
							...
							myTable.setSSelectWhat("'<a href=\"/public/jpage/1/p/story/a/storypage/sid/' || story_id || '/content.do\">' || title || '</a>' as url, '<a href=\"/editstory/jpage/1/p/story/content.do?id=' || story_id || '\">Edit</a>' as editbtn");

							myTable.setSCustomWhere("and posted_by = '"
							...
							<display:table name="requestScope.results.rows" requestURI="/postings/jpage/1/p/Postings/content.do" export="false" id="postTable" pagesize="50"  class="tabledatacollapse" style="width: 100%" >
			 <display:column property="url" title="Message Subject" />
			 <display:column property="editbtn" title="Edit" />
