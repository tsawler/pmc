...
<v:banner position_id="1" conn="<%=conn%>" />
	...
	rs = st.executeQuery("select "
		...
		+ "|| '/' "
		+ "|| img "
		+ "|| '\" rel=\"gb_imageset[theimageset]\" title=\"' "
		+ "|| title "
		+ "|| '\">'"
		+ "|| '<img alt=\"\" src=\"/gallery/'"
		+ "|| g.gallery_id "
		+ "|| '/'"
		+ "|| replace(img, '.', '_thumb.')" 
		+ "|| '\" /></a><br /><span style=\"font-size: 9pt\">Posted by: '"
		+ "|| username "
		+ "|| '</span></div></div>'"
		+ " as thehtml ,"
		+ " gd.img "
...
<form method="post" id="searchform" action="/membergallery/jpage/1/p/MemberGallery/content.do">
<input type="hidden" name="id" value="1" />
		<table class="tabledata" style="text-align: center" align="center">
		  <tr>
		    <td style="text-align: left;" align="left"> Posted by (Username)</td>
		  </tr>
		  <tr>
		    <td>
			<input type="text" name="username" id="username" class="inputbox" size="20" value="<%=username%>" />&nbsp;<input type="submit" value="Search" class="inputbox" />
			</td>
		  </tr>
		  </table>
		  </form>
			...
			<display:table name="results" style="text-align: center" pagesize="10" requestURI="/membergallery/jpage/1/p/MemberGallery/content.do">
